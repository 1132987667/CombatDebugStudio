...
export type AtomicEffectType = (typeof AtomicEffectType)[keyof typeof AtomicEffectType]
...
export interface IAtomicEffect {
  ...
  /** 生成 UI 显示文本 */
  getEffectLines?(ctx: BuffContext, params: Record<string, unknown>): BuffEffectLine[]
}
