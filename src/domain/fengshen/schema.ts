...
export const REFERENCE_RULES: ReferenceRule[] = [
  ...
  { sourceTable: 'drops', path: 'entries[].itemId', targetTables: ['materials', 'equipment', 'items'] },
  ...
  drops: {
    ...
    fields: [
      ...
      { key: 'entries', label: '掉落条目', type: 'array',
        ...
        arrayTemplate: [{ itemId: 'mat_taomu', probability: 80 }] },
    ],
    uniqueFields: ['name'],
  },
  affixes: {
  ...
  equipment_affixes: {
    ...
    fields: [
      ...
      { key: 'applicableSlots', label: '适用部位', type: 'array', required: true, searchable: true,
        ...
        arrayTemplate: ['weapon:轻型', 'accessory:戒指'] },
