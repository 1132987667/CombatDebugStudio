 ...
 * 功能: 配置管理器
 * 描述: 统一管理框架和业务配置，支持多环境配置（开发/测试/生产），配置热更新和动态加载，配置验证和类型安全，配置变更监听和通知
 * 版本: 1.0.0
 */
...
export class ConfigManager implements IConfigManager {
   ...
   * 监听配置变化
   */
  public onConfigChange<T>(
    key: string,
    callback: (newConfig: T) => void,
  ): void {
