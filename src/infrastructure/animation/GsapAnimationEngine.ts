...
import type { AnimationStrategy, AnimationContext } from './AnimationStrategy'
import { BaseAnimationStrategy } from './AnimationStrategy'
...
export abstract class BaseGsapStrategy extends BaseAnimationStrategy implements AnimationStrategy {
  ...
  protected createTween(
    ...
    const scaledDuration = vars.duration
      ? this.getScaledDuration(Number(vars.duration) * 1000) / 1000
      : undefined
