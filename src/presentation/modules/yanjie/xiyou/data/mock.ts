...
const XIYOU_DROPS: Record<string, EnemyDrop[]> = {
  ...
  花妖: [{ itemId: 'mat_taomu', quantity: 2, chance: 1 }],
  石精: [{ itemId: 'mat_cushi', quantity: 1, chance: 0.8 }],
  山魈: [{ itemId: 'mat_tongjing', quantity: 1, chance: 0.5 }],
  虾兵: [{ itemId: 'mat_beike', quantity: 1, chance: 1 }],
  蟹将: [{ itemId: 'mat_danshuiyu', quantity: 1, chance: 0.8 }],
  鱼精: [{ itemId: 'mat_beike', quantity: 1, chance: 0.5 }],
  痞猴: [{ itemId: 'mat_taomu', quantity: 1, chance: 0.6 }],
  货郎精: [{ itemId: 'mat_tongjing', quantity: 1, chance: 0.5 }],
  老狐: [{ itemId: 'mat_danshuiyu', quantity: 1, chance: 0.4 }],
  礁蟹: [{ itemId: 'mat_beike', quantity: 1, chance: 0.6 }],
  小蛟龙: [{ itemId: 'mat_sp_02', quantity: 1, chance: 0.3 }],
  // tang 区域（五行山/高老庄/浮屠山/流沙河）
  岩妖: [{ itemId: 'mat_cushi', quantity: 1, chance: 0.7 }],
  金精: [{ itemId: 'mat_jinjing', quantity: 1, chance: 0.4 }],
  山鬼: [{ itemId: 'mat_sp_01', quantity: 1, chance: 0.3 }],
  野猪精: [{ itemId: 'mat_lupi', quantity: 1, chance: 0.6 }],
  家仆妖: [{ itemId: 'mat_tongjing', quantity: 1, chance: 0.5 }],
  管家妖: [{ itemId: 'mat_shenshuiyu', quantity: 1, chance: 0.4 }],
  乌鸦精: [{ itemId: 'mat_songmu', quantity: 1, chance: 0.6 }],
  黄风怪: [{ itemId: 'mat_sp_02', quantity: 1, chance: 0.35 }],
  沙妖: [{ itemId: 'mat_cushi', quantity: 1, chance: 0.7 }],
  水蛇精: [{ itemId: 'mat_beike', quantity: 1, chance: 0.6 }],
  河伯: [{ itemId: 'mat_shenshuiyu', quantity: 1, chance: 0.4 }],
  // niliang 区域（黑风山/女儿国/琵琶洞/火焰山）
  黑熊精: [{ itemId: 'mat_xiongpi', quantity: 1, chance: 0.5 }],
  锦鼠: [{ itemId: 'mat_tiejing', quantity: 1, chance: 0.5 }],
  驿丞妖: [{ itemId: 'mat_tiemu', quantity: 1, chance: 0.5 }],
  花仙: [{ itemId: 'mat_hupi', quantity: 1, chance: 0.4 }],
  琵琶精: [{ itemId: 'mat_shengshui', quantity: 1, chance: 0.4 }],
  蝎子精: [{ itemId: 'mat_boss_02', quantity: 1, chance: 0.3 }],
  火蜥蜴: [{ itemId: 'mat_tieyan', quantity: 1, chance: 0.6 }],
  熔岩精: [{ itemId: 'mat_tiemu', quantity: 1, chance: 0.5 }],
  火童子: [{ itemId: 'crys_003', quantity: 1, chance: 0.3 }],
  // xiniu 区域（翠云山/狮驼岭/通天河/雷音寺）
  牛魔王: [{ itemId: 'mat_boss_01', quantity: 1, chance: 0.3 }],
  罗刹女: [{ itemId: 'mat_shengshui', quantity: 1, chance: 0.4 }],
  青狮精: [{ itemId: 'mat_feicui', quantity: 1, chance: 0.4 }],
  白象精: [{ itemId: 'mat_jinyang', quantity: 1, chance: 0.4 }],
  大鹏: [{ itemId: 'mat_boss_03', quantity: 1, chance: 0.3 }],
  灵感大王: [{ itemId: 'mat_dimai', quantity: 1, chance: 0.3 }],
  鱼妖: [{ itemId: 'mat_shenshuiyu', quantity: 1, chance: 0.5 }],
  六耳猕猴: [{ itemId: 'mat_hunyuan', quantity: 1, chance: 0.5 }],
}
