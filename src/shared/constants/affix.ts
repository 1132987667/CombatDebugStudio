...
export const AffixId = {
  ...
  // ── 三档·妖道（敌人，+60%）：天罚/不动/瞬影/焚天/噬魂/冥河/灭世/金钟/甘露/困仙/星辰·初 ──
  // NOTE: 五行护体系列（火/水/金/木/土灵护体、五行轮转、混元归一）随「五行系统暂不启用」裁定
  //       从 affixes.json 移除（《需求调整历史.md》#15）；启用五行时从 git 历史恢复。
  ...
  // ── 天命（BOSS 专属）：混世魔威/万毒归宗/大鹏展翅/六耳通灵/花妖王·灵根/山神·岩坚 ──
  // NOTE: 河伯·沧浪（唯一效果为 waterRes）随五行裁定移除，boss_major_hebo 的绑定同步删除。
